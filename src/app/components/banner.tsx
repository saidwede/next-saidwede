...
export default function Banner(){
    ...
    return (
        <div className="flex justify-center h-screen ">
            <div className="flex flex-col-reverse justify-end lg:justify-center lg:flex-row-reverse items-center gap-10 xl:gap-20 p-5 pt-20 lg:pt-0">
                <div className="grid gap-2">
                    ...
                    <p className=" max-w-[600px] text-neutral-600 text-2xl lg:text-4xl font-extralight">A senior Full-Stack Developer with expertise in both front-end and back-end technologies.</p>
                ...
                <div className="relative flex justify-center items-center h-[310px] aspect-square rounded-full ">
                    <div className=" z-10 absolute h-full w-full text-4xl font-extralight rotating">
                        <div className="absolute top-2 left-2 h-20 w-20 bg-black bg-opacity-5 rounded-full flex justify-center items-center">
                    ...
                    <div className=" z-10 absolute h-full w-full text-4xl font-extralight rotating">
                        <div className="absolute bottom-2 right-2 h-20 w-20 bg-black bg-opacity-5 rounded-full flex justify-center items-center">
                    ...
                    <div className="flex justify-center items-center h-[280px] aspect-square rounded-full ">
                        ...
                        <div className="h-[250px] aspect-square relative  rounded-full">
                            <div className="h-[calc(100%-10px)] aspect-square  rounded-full bg-white overflow-hidden flex items-end absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
